...
<head>
<meta charset="UTF-8">
<title>DetailDeclarationNewSpeedUserList.jsp</title>
...
<div class="col-xs-12 col-md-9">
		...
		<div class="row" style="padding: 30px 0px;">
			...
			<c:if test="${empty result}"><td>신고리스트가 없습니다.<td><a href="DetailDeclarationCommunityUserList.jsp">커뮤니티상세조회</a></td></td></c:if>	
...
<c:import url="/menu/Admin_futter.jsp"></c:import>
