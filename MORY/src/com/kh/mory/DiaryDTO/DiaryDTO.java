...
public class DiaryDTO 
{
	...
	String comment_seq , comment_cont,comment_reg_dtm;
	String diary_requ_seq,reco_cont,reco_reg_dtm;
	String reco_seq  ;
	String shar_diary_name , share_diary_seq;
	
	public String getShare_diary_seq()
	{
		return share_diary_seq;
	}
	public void setShare_diary_seq(String share_diary_seq)
	{
		this.share_diary_seq = share_diary_seq;
	}
	public String getShar_diary_name()
	{
		return shar_diary_name;
	}
	public void setShar_diary_name(String shar_diary_name)
	{
		this.shar_diary_name = shar_diary_name;
	}
	...
	public void setComment_seq(String commentseq)
	{
		this.comment_seq = commentseq;
	}
